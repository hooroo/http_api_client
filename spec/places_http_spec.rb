...
describe PlacesHttp do

  context "without rails" do

    describe ".env" do
      it 'returns "test"' do
        expect(PlacesHttp.env).to eq 'test'
      end
    end

    describe ".logger" do
      it 'returns a stub logger' do
        expect(PlacesHttp.logger).to_not be_nil
      end
    end
  ...
  context "with rails" do
    ...
    describe ".env" do
      it 'returns the current rails environment' do
        expect(PlacesHttp.env).to eq Rails.env
      end
    end

    describe ".logger" do
      it 'returns the rails logger' do
        expect(PlacesHttp.logger).to eq Rails.logger
      end
    end
